...
window.CorporateUi = (function() {
  ...
  function setGlobals() {
    ...
    public.components = {
      'corporate-header': window.version_root + '/components/corporate-header/corporate-header.html',
      'corporate-footer': window.version_root + '/components/corporate-footer/corporate-footer.html',
      'main-content': window.version_root + '/components/main-content/main-content.html',
      'main-navigation': window.version_root + '/components/main-navigation/main-navigation.html'
    };
