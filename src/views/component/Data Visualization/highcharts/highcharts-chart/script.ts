        ...
        this._set_chart(new Highcharts[namespace||"Chart"]($.extend(true,{},{
            chart: $.extend({
                ...
                events: {
                    ...
                    drillupall: function(e){__app.fire("drill-up-all",{e: e,chart: this,component:__app})},
                    selection: function(e){__app.fire("selection",{e: e,chart: this,component:__app})},
                    redraw: function(e){__app.fire("redraw",{e: e,chart: this,component:__app})},
                    render: function(e){__app.fire("render",{e: e,chart: this,component:__app})},
                }
